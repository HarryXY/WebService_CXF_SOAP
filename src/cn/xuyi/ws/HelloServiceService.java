 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://ws.xuyi.cn/", wsdlLocation = "http://192.168.100.107:6789/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://ws.xuyi.cn/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.100.107:6789/hello?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws.xuyi.cn/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.xuyi.cn/", "HelloServicePort"), HelloService.class, features);
    }
